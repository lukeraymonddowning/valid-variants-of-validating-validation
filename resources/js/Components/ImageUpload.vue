...
<template>
    ...
    >
        <div class="space-y-1 text-center" :class="{'pointer-events-none': isBeingDraggedOver}">
            <img v-if="state.preview" :src="state.preview" alt="Image preview" class="h-32 mx-auto mb-2">
            ...
            <div class="flex text-sm text-gray-600">
                <label :for="props.id" class="relative cursor-pointer rounded-md bg-white font-medium text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">
